...
const mixinwallet = window.mixinwallet;
...
describe("TrustWeb3Provider constructor tests", () => {
  ...
  test("test Solana setAddress", () => {
    const provider = new mixinwallet.SolanaProvider({
      solana: {
    ...
    expect(provider.isMixin).toBeTruthy();
  ...
  test("test setConfig", (done) => {
    const provider = new mixinwallet.Provider({ ethereum: ropsten });
    const web3 = new Web3(provider);
  ...
  test("test eth_chainId", (done) => {
    const provider = new mixinwallet.Provider({ ethereum: bsc });
    const web3 = new Web3(provider);
  ...
  test("test eth_accounts", (done) => {
    const provider = new mixinwallet.Provider({ ethereum: mainnet });
    const web3 = new Web3(provider);
  ...
  test("test eth_sign", (done) => {
    ...
    mixinwallet.postMessage = (message) => {
